  ...
  describe('local search', () => {
    ...
    describe('matching branch nodes', () => {
      ...
      it('expand a branch node should show all its children', async () => {
        ...
        await nextTick()
        expect(wrapper.find('.vue-treeselect__option[data-id="aa"]').exists()).toBe(true)
        expect(wrapper.find('.vue-treeselect__option[data-id="ab"]').exists()).toBe(true)
        expect(wrapper.find('.vue-treeselect__option[data-id="ac"]').exists()).toBe(true)
        expect(vm.forest.nodeMap.ac.isExpandedOnSearch).toBe(false)
        vm.toggleExpanded(vm.forest.nodeMap.ac)
        await nextTick()
        expect(wrapper.find('.vue-treeselect__option[data-id="aca"]').exists()).toBe(true)
      })
    })
